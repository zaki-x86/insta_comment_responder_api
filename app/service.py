...
class FBBService:
    """
    This class intreacts with Meta Graph API
    """
    ...
    def process_new_comment_notification(
        self, data
    ) -> Tuple[Optional[int], Optional[str]]:
        """
        Processes data incoming from a new comment webhook event and returns comment id and text.
        """
    ...
    def reply_to_comment(self, comment_id: str, message: str):
        """
        Replies to a comment on instagram given comment id and message, returns the posted reply id
        """
